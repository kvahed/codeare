 ...
 */
# define TEST_VECT(M) assert((M)->width() == 1 || (M)->height() == 1);
...
public:
     ...
     */
    inline              Matrix               (int col, int lin, int cha, int set, 
     ...
     * @return          Constructed matrix.
     */
    inline              Matrix               (Matrix<int> &dim);
	

	/**
	 * @brief           Populates a matrix of same size as the access specifier and initialised with its values.
	 * 
	 * @param  ias      ICE access specifier
     ...
     */
	int                 height              () const {return _dim[LIN];}
     ...
     */
	int                 width               () const {return _dim[COL];}
     ...
     * @return          Number of rows.
     */
	inline int          Dim              (int i)                                const {return _dim[i];}
     ...
     * @return          Number of rows.
     */
	inline void         Dim              (const int* dim)                                     const {
     ...
     */
	Matrix<T>           operator()        (Matrix<int> &p)                    const;
     ...
     */
	Matrix<T>           operator()        (Matrix<int> &c, Matrix<int> &l)  const;
  ...
  /**
     ...
     */
    Matrix<bool>        operator==          (Matrix<T> M);
     ...
     */
    Matrix<T>           lin                 (Matrix<int> l)                     const;
     ...
     */
    Matrix<T>           col                 (Matrix<int> c)                     const;
