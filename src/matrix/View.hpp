...
public:
  ...
  virtual size_t NDim() const  { return 0; }
	...
	virtual LHSView operator() (R) { return LHSView(); }
	virtual RHSView operator() (CR) const { return RHSView(); }
	virtual LHSView operator() (R, const size_t&) { return LHSView(); }
	virtual RHSView operator() (CR, const size_t&) const { return RHSView(); }
	virtual LHSView operator() (R, R) { return LHSView(); }
	virtual RHSView operator() (CR, CR) const { return RHSView(); }
	virtual LHSView operator() (R, R, R) { return LHSView(); }
	virtual RHSView operator() (CR, CR, CR) const { return RHSView(); }
	virtual LHSView operator() (R, R, R, R) { return LHSView(); }
	virtual RHSView operator() (CR, CR, CR, CR) const { return RHSView(); }
	virtual LHSView operator() (R, R, R, R, R) { return LHSView(); }
	virtual RHSView operator() (CR, CR, CR, CR, CR) const { return RHSView(); }
	virtual LHSView operator() (R, R, R, R, R, R) { return LHSView(); }
	virtual RHSView operator() (CR, CR, CR, CR, CR, CR) const { return RHSView(); }
private:
  Vector<T> _M;
	Vector<size_t> _dim;
};
