	  ...
	  <body>
		...
		<div id="sidebar">
		  ...
		  <div class="callout">
			...
			<span class="date">23 mar 2012</span><br/>kaveh vahedipour</a>
		  </div>
		  <br/>
		...
		<div id="rightbar">
		  <div class="callout">
			<h1>visit also</h1> <br/>
			<a href="http://www.jemris.org" target="_jemris">
			  jemris mri simulator
			  </a><br/>
			  open-source full-featured parallel tx/rx mri sequence and
			  hardware simulator.
			  <br/><br/> 
			  <a href="http://www.drcmr.dk/bloch" target="_hansen">
				...
				<br/><br/> 
				<a href="http://www.ismrm.org/mri_unbound/"	target="_mriunbound">
				  mri unbound
				  </a><br/>
